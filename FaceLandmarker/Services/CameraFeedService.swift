...
class CameraFeedService: NSObject {
    ...
    /**
     This method stops a running AVCaptureSession.
     */
    func stopSession() {
        ...
        sessionQueue.async {
            if self.session.isRunning {
                ...
                print("Camera session stopped. Is session running: \(self.isSessionRunning)")
            }
        }
    }
    ...
    private func startSession() {
        ...
        self.isSessionRunning = self.session.isRunning
        print("Camera session started. Is session running: \(self.isSessionRunning)")
    }

    // MARK: Session Configuration Methods.
    /**
     This method requests camera permissions and handles the configuration of the session and stores the result of configuration.
     */
